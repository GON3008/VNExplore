...
class HotelManagerController extends Controller
{
    public function index()
    {
        ...
        $usedRoomBook = RoomBookings::pluck('room_option_id')->toArray();
        ...
        $roomOptionForBook = RoomOption::whereNotIn('id', $usedRoomBook)->get();

        return view('admin.hotel_manager.index', compact(
            'hotelCategory', 'hotelRoom', 'created_by',
            'roomOptionsForAvail','roomOptionsForPolicies','roomOptionForBook','roomDetails'
        ));
    }
