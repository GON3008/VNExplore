        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="flightForm" name="flightForm" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="location_departure_id" class="col-sm-5 control-label">Location Departure</label>
                        <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        <label for="location_arrival_id" class="col-sm-5 control-label">Location Arrival</label>
                        <div class="col-sm-12">
