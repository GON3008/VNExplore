<div class="modal fade" id="ajaxMode_listCategory" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="modelHeading_listCategory"></h4>
                <span type="button" class="close" data-bs-dismiss="modal" aria-label="Close" aria-hidden="true">
                    <i class="uil-multiply"></i>
                </span>
            </div>
            <div class="modal-body">
                <form id="listCategoryForm" name="listCategoryForm" class="form-horizontal" enctype="multipart/form-data">
                    @csrf
