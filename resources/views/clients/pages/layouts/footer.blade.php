            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="footer-widget">
                        <div class="d-flex align-items-start flex-column mb-3">
                            <div class="d-inline-block"><img src="{{asset('geotrip/assets/img/logo-light.png')}}" class="img-fluid" width="160"
                                                             alt="Footer Logo"></div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-widget">
                        ...
                        <div class="pmt-wrap">
                            <img src="{{asset('geotrip/assets/img/payment.png')}}" class="img-fluid" alt="">
                        </div>
                        <div class="our-prtwrap mt-4">
                            ...
                            <div class="prtn-thumbs d-flex align-items-center justify-content-start">
                                <div class="pmt-wrap pe-4">
                                    <img src="{{asset('geotrip/assets/img/mytrip.png')}}assets/img/mytrip.png" class="img-fluid" alt="">
                                </div>
                                <div class="pmt-wrap pe-4">
                                    <img src="{{asset('geotrip/assets/img/tripadv.png')}}" class="img-fluid" alt="">
                                </div>
                                <div class="pmt-wrap pe-4">
                                    <img src="{{asset('geotrip/assets/img/goibibo.png')}}" class="img-fluid" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
