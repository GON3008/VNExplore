                ...
                <div class="row">
                        ...
                        <div class="w100 fl bx-wap-pr-item">
                            <div class="clearfix box-wap-imgpr">
                                <a href="https://vietnamtravel.net.vn/vi/chi-tiet-san-pham/470-tour-hot-nhat-he-2023-quy-nhon-phu-yen-xu-nau-dep-nhat-viet-nam.html">
                                    <img src="{{asset('frontend/imgs/logo-ghenh-da-dia.jpg')}}" class="img-default" alt="tour" style="margin-bottom: 6px;">
                                    <img src="{{asset('frontend/imgs/merry-christmas-1.png')}}" class="img-event-giang-sinh">                <!--<img src="/public/media/images/logo/logo-ghim-anh.jpg" class="img-ghim-anh">-->
                                </a>
                            </div>
                            <div class="clear"></div>
                    ...
                    <div class="col-md-4 col-xs-12 lst-tour-item">
                        <div class="w100 fl bx-wap-pr-item">
                            <div class="clearfix box-wap-imgpr">
                                <a href="https://vietnamtravel.net.vn/vi/chi-tiet-san-pham/470-tour-hot-nhat-he-2023-quy-nhon-phu-yen-xu-nau-dep-nhat-viet-nam.html">
                                    <img src="imgs/logo-ghenh-da-dia.jpg" class="img-default" alt="tour" style="margin-bottom: 6px;">
                                    <img src="imgs/merry-christmas-1.png" class="img-event-giang-sinh">                <!--<img src="/public/media/images/logo/logo-ghim-anh.jpg" class="img-ghim-anh">-->
                                </a>
                            </div>
                            <div class="clear"></div>
                            <h4><a href="https://vietnamtravel.net.vn/vi/chi-tiet-san-pham/470-tour-hot-nhat-he-2023-quy-nhon-phu-yen-xu-nau-dep-nhat-viet-nam.html">Tour Hot nhất Hè 2023 Quy Nhơn - Phú Yên (Xứ Nẫu đẹp nhất Việt Nam)</a></h4>
