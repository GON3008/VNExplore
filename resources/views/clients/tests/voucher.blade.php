                    ...
                    <div class="card bg-light-success rounded-3 p-4 m-0">
                        <div class="card-body py-3 px-1">
                            <div class="position-relative">
                                <div class="offers-pic"><img src="{{asset('geotrip/assets/img/flt-3.png')}}" class="img-fluid rounded" width="150" alt=""></div>
                            </div>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="pop-touritems">
                    <div class="card bg-light-purple rounded-3 p-4 m-0">
                        <div class="card-body py-3 px-1">
                            <div class="position-relative">
                                <div class="offers-pic"><img src="{{asset('geotrip/assets/img/goibibo.png')}}" class="img-fluid rounded" width="150" alt="">
                                </div>
                            </div>
                            <div class="position-relative py-4 my-1">
                                <span class="mb-1 text-dark fw-medium">Flat</span>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="bg-light-purple border border-2 border-info br-dashed rounded-2 px-3 py-2">
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="pop-touritems">
                    <div class="card bg-light-danger rounded-3 p-4 m-0">
                        <div class="card-body py-3 px-1">
                            <div class="position-relative">
                                <div class="offers-pic"><img src="{{asset('geotrip/assets/img/flt-2.png')}}" class="img-fluid rounded" width="150" alt=""></div>
                            </div>
                            <div class="position-relative py-4 my-1">
                                <span class="mb-1 text-dark fw-medium">Flat</span>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="pop-touritems">
                    <div class="card bg-light-warning rounded-3 p-4 m-0">
                        <div class="card-body py-3 px-1">
                            <div class="position-relative">
                                <div class="offers-pic"><img src="{{asset('geotrip/assets/img/flt-1.png')}}" class="img-fluid rounded" width="150" alt=""></div>
                            </div>
                            <div class="position-relative py-4 my-1">
                                <span class="mb-1 text-dark fw-medium">Flat</span>
