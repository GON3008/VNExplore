                            ...
                            <ul
                                ...
                                <li class="col">
                                    <a class="selectCountry" href="#">
                                        <div class="d-inline-block"><img src="{{asset('geotrip/assets/img/flag/united-states.png')}}" class="img-fluid circle"
                                                                         width="35" alt=""></div>
                                ...
                                <li class="col">
                                    <a class="selectCountry" href="#">
                                        <div class="d-inline-block"><img src="{{asset('geotrip/assets/img/flag/united-kingdom.png')}}" class="img-fluid circle"
                                                                         width="35" alt=""></div>
                                ...
                                <li class="col">
                                    <a class="selectCountry active" href="#">
                                        <div class="d-inline-block"><img src="{{asset('geotrip/assets/img/flag/flag.png')}}" class="img-fluid circle" width="35"
                                                                         alt=""></div>
                                ...
                                <li class="col">
                                    <a class="selectCountry" href="#">
                                        <div class="d-inline-block"><img src="{{asset('geotrip/assets/img/flag/belgium.png')}}" class="img-fluid circle" width="35"
                                                                         alt=""></div>
                                ...
                                <li class="col">
                                    <a class="selectCountry" href="#">
                                        <div class="d-inline-block"><img src="{{asset('geotrip/assets/img/flag/brazil.png')}}" class="img-fluid circle" width="35"
                                                                         alt=""></div>
                                ...
                                <li class="col">
                                    <a class="selectCountry" href="#">
                                        <div class="d-inline-block"><img src="{{asset('geotrip/assets/img/flag/china.png')}}" class="img-fluid circle" width="35"
                                                                         alt=""></div>
                    ...
                    <div class="suggestedCurrencylist-wrap">
                        ...
                        <div class="suggestedCurrencylists">
                            <ul
                                ...
                                <li class="col">
                                    <a class="selectCountry" href="#">
                                        <div class="d-inline-block"><img src="{{asset('geotrip/assets/img/flag/vietnam.png')}}" class="img-fluid circle" width="35"
                                                                         alt=""></div>
                                ...
                                <li class="col">
                                    <a class="selectCountry" href="#">
                                        <div class="d-inline-block"><img src="{{asset('geotrip/assets/img/flag/turkey.png')}}" class="img-fluid circle" width="35"
                                                                         alt=""></div>
                                ...
                                <li class="col">
                                    <a class="selectCountry" href="#">
                                        <div class="d-inline-block"><img src="{{asset('geotrip/assets/img/flag/spain.png')}}" class="img-fluid circle" width="35"
                                                                         alt=""></div>
                                ...
                                <li class="col">
                                    <a class="selectCountry" href="#">
                                        <div class="d-inline-block"><img src="{{asset('geotrip/assets/img/flag/japan.png')}}" class="img-fluid circle" width="35"
                                                                         alt=""></div>
                                        <div class="text-dark text-md fw-medium ps-2">Australian Dollar</div>
                                    </a>
                                </li>
                                ...
                                <li class="col">
                                    <a class="selectCountry" href="#">
                                        <div class="d-inline-block"><img src="{{asset('geotrip/assets/img/flag/portugal.png')}}" class="img-fluid circle"
                                                                         width="35" alt=""></div>
                                ...
                                <li class="col">
                                    <a class="selectCountry" href="#">
                                        <div class="d-inline-block"><img src="{{asset('geotrip/assets/img/flag/italy.png')}}" class="img-fluid circle" width="35"
                                                                         alt=""></div>
                                ...
                                <li class="col">
                                    <a class="selectCountry" href="#">
                                        <div class="d-inline-block"><img src="{{asset('geotrip/assets/img/flag/germany.png')}}" class="img-fluid circle" width="35"
                                                                         alt=""></div>
                                ...
                                <li class="col">
                                    <a class="selectCountry" href="#">
                                        <div class="d-inline-block"><img src="{{asset('geotrip/assets/img/flag/france.png')}}" class="img-fluid circle" width="35"
                                                                         alt=""></div>
                                ...
                                <li class="col">
                                    <a class="selectCountry" href="#">
                                        <div class="d-inline-block"><img src="{{asset('geotrip/assets/img/flag/european.png')}}" class="img-fluid circle"
                                                                         width="35" alt=""></div>
