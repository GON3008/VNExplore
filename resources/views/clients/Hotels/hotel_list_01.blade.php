...
@section('hotel_content')
    <div class="row align-items-center g-4 mt-2">
        ...
        @foreach($data->slice(0,3) as $item)
            @if($item->hotelCategory_status == 1 && $item->hotelCategory_deleted == 1
                 && in_array($item->category->name, ['Hotels', 'Hotel', 'hotels', 'hotel']))
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl col-lg col-md">
                                <div class="listLayout_midCaps mt-md-0 mt-3 mb-md-0 mb-3">
                                    ...
                                    {{--                                    <div class="row g-2 detail ellipsis-container mt-0">--}}
                                    {{--                                        @php--}}
                                    {{--                                            $services = [--}}
                                ...
                                <div class="position-relative mt-auto full-width">
                                    ...
                                    <div
                                        ...
                                        <div class="text-muted-2 fw-medium text-decoration-line-through me-2">
                                            ${{$item->getLowestDiscount() ?? 'Not Available'}}
                                        </div>
                                        <div class="text-dark fw-bold fs-3">
                                            ${{ $item->getLowestPrice() ?? 'Not Available' }}</div>
                                    </div>
                                    <div
        ...
        <!-- Offer Coupon Box -->
        <div class="col-xl-12 col-lg12 col-md-12 py-3">
            <div
        ...
        <!-- end Offer Coupon Box -->


        <!-- Single List -->
        @foreach($data->slice(3,3) as $item)
            @if($item->hotelCategory_status == 1 && $item->hotelCategory_deleted == 1
                 && in_array($item->category->name, ['Hotels', 'Hotel', 'hotels', 'hotel']))
                <div class="col-xl-12 col-lg-12 col-12">
                    <div class="card list-layout-block rounded-3 p-3">
